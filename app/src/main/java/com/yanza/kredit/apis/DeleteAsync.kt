...
class DeleteAsync
    (private val userId: Int, val loanId: Int?, val responseModel: MutableLiveData<ResponseBooleanModel>, val errorString: MutableLiveData<String>): AsyncTask<Void, Int, String>() {
        override fun doInBackground(vararg p0: Void?): String {
            val url = Const.YANZA_KREDIT+"cancelloan"
